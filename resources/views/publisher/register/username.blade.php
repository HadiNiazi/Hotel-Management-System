...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Publisher {{ __('Register') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('publisher.register.username.store') }}">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <a href="{{ route('publisher.login.username') }}" class="btn btn-primary">
                                    {{ __('Login') }}
                                </a>
                            </div>
                        </div>
